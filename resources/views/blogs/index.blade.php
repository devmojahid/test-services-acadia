...
<body>
    ...
    <!--HEADER-->
    <header style="background: linear-gradient(rgba(1,1,1,.5), rgba(1,1,1,.5)), url(../images/#);">
        <section>
            <h1 class="title">Our Blog</h1>
            <span><a href="/PRABHUPADAWORLD/">Home</a> <i class="fa fa-angle-double-right"></i> <a href="#"
    ...
    <div class="blog_container">
        <div class="blog_content">
            <div class="left_content">
                ...
                @php
                    $blogs = App\Models\Blog::with(['files', 'thumbnail'])
                        ->orderBy('id', 'desc')
                        ->get();
                @endphp
                    ...
                    <div class="blog_card">
                        ...
                        <a href="article.html" class="figure">
                            @foreach ($blog->files as $file)
                                <img src="{{ get_file_url($file->file_path) }}" alt="" loading="lazy">
                            @endforeach
                            {{-- <img src="https://i.postimg.cc/KcwkZQsx/dummy.png" alt="" loading="lazy"> --}}
                            <span class="tag">15 JAN</span>
                        </a>
        ...
        <div class="blog_content right_content">
            ...
            <div class="columns search_column">
                <section class="search">
                    <form>
                        <fieldset><input type="text" name="search" placeholder="Search..." maxlength="100"
                                required=""></fieldset>
                        <fieldset><button type="submit" class="btn1"><i class="fa fa-search"></i></button>
                        </fieldset>
                    </form>
                </section>
            </div>
            ...
            <div class="columns books">
                <span class="title">New Books <a href="#" title="Explore More"><i
                            class="fa fa-share"></i></a></span>
                <section>
                    <div class="cards">
                        <div class="card_part card_part-one"
                            style="background-image: url(https://i.postimg.cc/2SD5y5RS/book-1.png);"></div>
            ...
            <div class="columns posts">
                <span class="title">Recent Posts <a href="#" title="Explore More"><i
                            class="fa fa-share"></i></a></span>
                <section>
            ...
            <div class="columns comments">
                <span class="title"> Recent Comments <a href="#" title="Explore More"><i
                            class="fa fa-share"></i></a></span>
                <section>
                    <marquee direction="up" scrollamount="4" onMouseOver="this.stop()" onMouseOut="this.start()"
                        class="marquee2">
                        <p>Remember, torn clothes should not be left at home. Dispose of them out. Buying new clothes
                            like towels.</p>
                        <p>wearing clothes, bedsheets are like inviting good luck to the home.</p>
                        <p>Arrange doormats before every door and please change the doormats once in 6/8 months or
                            maximum within 1 year. For More Daily</p>
                    </marquee>
                </section>
            </div>
